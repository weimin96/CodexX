...
const lightThemeOverrides: GlobalThemeOverrides = {
  ...
  Menu: {
    color: 'transparent',
    itemColorHover: 'rgba(29, 29, 31, 0.06)',
    itemColorActive: 'rgba(29, 29, 31, 0.08)',
    itemColorActiveHover: 'rgba(29, 29, 31, 0.12)',
    itemTextColor: 'rgba(29, 29, 31, 0.72)',
    itemTextColorHover: '#1d1d1f',
    itemTextColorActive: '#1d1d1f',
    itemTextColorActiveHover: '#1d1d1f',
    itemIconColor: 'rgba(29, 29, 31, 0.72)',
    itemIconColorHover: '#1d1d1f',
    itemIconColorActive: '#1d1d1f',
    itemIconColorActiveHover: '#1d1d1f',
